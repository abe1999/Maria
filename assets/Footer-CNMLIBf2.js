          ...
          <ul>
            ...
            <li class="dropdown">
              ...
              <div class="dropdown-content">
                <a href="/Maria/pages/eventos.html?categoria=evento-geral">Eventos Gerais</a>
                <a href="/Maria/pages/eventos.html?categoria=missa">Missas</a>
                <a href="/Maria/pages/proximos-eventos.html">Próximos Eventos</a>
              </div>
            </li>
            <li><a href="/Maria/pages/acampamento.html">Acampamento</a></li>
          </ul>
        </nav>
