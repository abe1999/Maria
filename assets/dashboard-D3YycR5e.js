import"./modulepreload-polyfill-B5Qt9EMX.js";import"./auth-guard-Y9PVmm_w.js";/* empty css                  */import{f as s,e as i,a as c,d as r,h as d,q as l,c as m,o as u,g as v}from"./firebase-config-DO1K0Gcl.js";const f=document.getElementById("logout-button"),o=document.getElementById("events-list-container");f.addEventListener("click",async()=>{if(confirm("Tem certeza que deseja sair?"))try{await s(i),alert("Você saiu com sucesso."),window.location.href="/admin/login.html"}catch(t){console.error("Erro ao fazer logout:",t),alert("Não foi possível sair. Tente novamente.")}});async function p(){if(o)try{const t=l(m(r,"eventos"),u("date","desc")),a=(await v(t)).docs.map(e=>({id:e.id,...e.data()}));if(a.length===0){o.innerHTML="<p>Nenhum evento cadastrado ainda.</p>";return}o.innerHTML=a.map(e=>`
