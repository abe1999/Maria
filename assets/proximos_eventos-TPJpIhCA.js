import{r as o,a as i}from"./Footer-CyP6qy2r.js";/* empty css                    *//* empty css                */import{a as s}from"./eventos-DQUT92KO.js";function l(t){return new Date(t+"T00:00:00").toLocaleDateString("pt-BR",{day:"2-digit",month:"long",year:"numeric"})}function c(t){const e=t.link.startsWith("http")?t.link:`/Maria/${t.link.replace(/^\//,"")}`,a=t.image.startsWith("http")?t.image:`/Maria/${t.image.replace(/^\//,"")}`;return`
