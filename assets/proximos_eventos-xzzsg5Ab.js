import{r as o,a as i}from"./Footer-BZh9Zm0S.js";/* empty css                    *//* empty css                */import{a as s}from"./eventos-B3CRVrOn.js";function l(t){return new Date(t+"T00:00:00").toLocaleDateString("pt-BR",{day:"2-digit",month:"long",year:"numeric"})}function c(t){const e=t.link.startsWith("http")?t.link:`/${t.link.replace(/^\//,"")}`,a=t.image.startsWith("http")?t.image:`/${t.image.replace(/^\//,"")}`;return`
