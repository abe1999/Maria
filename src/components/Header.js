...
// Importe a imagem do logo usando um caminho relativo.
// Isso garante que o Vite resolva o caminho corretamente,
// independentemente de onde o arquivo Header.js esteja.
...
export function renderHeader() {
  ...
  const headerHTML = `
    <header class="main-header" id="main-header">
      <div class="container">
        <a href="/" class="logo">
<img src="${logoImage}" alt="Logo da Paróquia Nossa Senhora de Nazaré" />        </a>
